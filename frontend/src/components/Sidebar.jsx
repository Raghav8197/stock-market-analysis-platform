...
const Sidebar = ({ activeTab, setActiveTab, onOpenAuth }) => {
  ...
  const menuItems = [
    ...
    { id: "charts", label: "Interactive Charts", icon: BarChart2 },
    { id: "screener", label: "Stock Screener", icon: Filter },
    { id: "funds", label: "Mutual Funds", icon: PieChart },
    { id: "ai", label: "AI Insights", icon: Cpu },
    { id: "alerts", label: "Alerts Setup", icon: Bell },
  ];

  return (
    <aside className="w-64 bg-darkCard border-r border-gray-800 flex flex-col h-screen select-none shrink-0">
      {/* Brand Logo */}
